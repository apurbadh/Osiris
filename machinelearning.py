...
def prediction(lst):
	answer = ""
	descisionTreeModel = pickle.load(open("models/desicionTree.model", "rb"))
	naiveBayesModel = pickle.load(open("models/naiveBayes.model", 'rb'))
	randomForestModel = pickle.load(open("models/randomForest.model", 'rb'))
